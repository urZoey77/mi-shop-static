...
const NormalItems = ({ classTitle, itemInfo, buttonInfo }) => {
  return (
    <div className={styles.topItems}>
      ...
      <div className={styles.classContent}>
        ...
        <div className={styles.normalGoods}>
          {itemInfo.slice(1, 10).map((item, index) => (
          ...
          <div className={styles.moreGoods}>
            ...
            <div className={styles.moreGoodsItem}>
              <div className={styles.moreGoodsIntro}>
                ...
                <div className={styles.browseMoreClass}>{buttonInfo[0]}</div>
              </div>
